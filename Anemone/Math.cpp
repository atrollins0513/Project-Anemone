...
namespace Anemone
{
	...
	AE_FLOAT& mat3::operator[](std::size_t index)
	{
		return mat[index];
	}

	const AE_FLOAT& mat3::operator[](std::size_t index) const
	{
		return mat[index];
	}
	...
	AE_FLOAT& mat4::operator[](std::size_t index)
	{
		return mat[index];
	}

	const AE_FLOAT& mat4::operator[](std::size_t index) const
	{
		return mat[index];
	}
